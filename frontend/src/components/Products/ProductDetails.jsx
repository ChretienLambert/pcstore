          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="md:w-1/2 md:ml-10">
              ...
              <button
                ...
                className={`bg-[#5C5CFF] text-white py-2 px-6 rounded w-full mb-4 cursor-pointer ${
                  isButtonDisabled ? "cursor-not-allowed" : "hover:bg-blue-300"
                }`}
              >
