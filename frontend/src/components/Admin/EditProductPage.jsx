    ...
    <div className="max-w-5xl mx-auto p-6 shadow-md rounded-md">
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
                ...
                <input type="text" name="sizes" value={productData.sizes} onChange={(e)=>
                    setProductData({
                        ...productData,
            ...
            <div className="mb-6">
                ...
                <input type="text" name="colors" value={productData.colors} onChange={(e)=>
                    setProductData({
                        ...productData,
            ...
            <button type="submit" className=" w-full bg-emerald-500 hover:bg-emerald-700 px-2 py-1 rounded mr-2 cursor-pointer text-white transition-colors">
                Update Product
            </button>
